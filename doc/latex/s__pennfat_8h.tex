\doxysection{src/pennfat/s\+\_\+pennfat.h File Reference}
\hypertarget{s__pennfat_8h}{}\label{s__pennfat_8h}\index{src/pennfat/s\_pennfat.h@{src/pennfat/s\_pennfat.h}}


Penn\+FAT system calls.  
...
\item 
int \mbox{\hyperlink{s__pennfat_8h_a7c51d3389a647801b0fd33cf67548984}{get\+\_\+fd\+\_\+index\+\_\+from\+\_\+address}} (\mbox{\hyperlink{struct_k_file_descriptor}{KFile\+Descriptor}} \texorpdfstring{$\ast$}{*}fd)
\begin{DoxyCompactList}\small\item\em Retrieves the index of a file descriptor from its address. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{s__pennfat_8h_afec6e61720e05918efefeab347e950f3}{s\+\_\+open}} (const char \texorpdfstring{$\ast$}{*}fname, int mode)
...
int \mbox{\hyperlink{s__pennfat_8h_a87d6adb8e7b0eaccc8dd4b1f3ba14e9a}{s\+\_\+read}} (int fd, int n, char \texorpdfstring{$\ast$}{*}buf)
\begin{DoxyCompactList}\small\item\em Reads n bytes from a file into a buffer. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{s__pennfat_8h_a2a41e90899b39cae94c9d02c3922ea81}{s\+\_\+write}} (int fd, const char \texorpdfstring{$\ast$}{*}str, int n)
\begin{DoxyCompactList}\small\item\em Writes n bytes from a string to a file. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{s__pennfat_8h_aba629deac31aa467ccb7763148dd4f92}{s\+\_\+append}} (int fd, const char \texorpdfstring{$\ast$}{*}str, int n)
\begin{DoxyCompactList}\small\item\em Appends n bytes from a string to the end of the file. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{s__pennfat_8h_a1ee856dbd0706f79a440d1e98b42d32d}{s\+\_\+close}} (int fd)
...
int \mbox{\hyperlink{s__pennfat_8h_a395873f1de0b89a686d438580ba5dcf7}{s\+\_\+unlink}} (const char \texorpdfstring{$\ast$}{*}fname)
\begin{DoxyCompactList}\small\item\em Removes a file from the filesystem. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{s__pennfat_8h_a5d3410d3c150ad3ac75e6f061948a31f}{s\+\_\+lseek}} (int fd, int offset, int whence)
\begin{DoxyCompactList}\small\item\em Repositions the file pointer of an open file descriptor. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{s__pennfat_8h_ae166ac7970869bda5550149e8771c3af}{s\+\_\+ls}} (const char \texorpdfstring{$\ast$}{*}filename, int fd)
...
int \mbox{\hyperlink{s__pennfat_8h_a9ec64e2714b83fdba459578a89d77c32}{s\+\_\+is\+\_\+executable}} (const char \texorpdfstring{$\ast$}{*}filename)
...
This file contains the declarations for the system calls that interact with the Penn\+FAT filesystem.

\doxysubsection{Function Documentation}
\Hypertarget{s__pennfat_8h_a7c51d3389a647801b0fd33cf67548984}\label{s__pennfat_8h_a7c51d3389a647801b0fd33cf67548984} 
\index{s\_pennfat.h@{s\_pennfat.h}!get\_fd\_index\_from\_address@{get\_fd\_index\_from\_address}}
\index{get\_fd\_index\_from\_address@{get\_fd\_index\_from\_address}!s\_pennfat.h@{s\_pennfat.h}}
...
\end{DoxyReturn}
\Hypertarget{s__pennfat_8h_aba629deac31aa467ccb7763148dd4f92}\label{s__pennfat_8h_aba629deac31aa467ccb7763148dd4f92} 
\index{s\_pennfat.h@{s\_pennfat.h}!s\_append@{s\_append}}
\index{s\_append@{s\_append}!s\_pennfat.h@{s\_pennfat.h}}
...
\end{DoxyReturn}
\Hypertarget{s__pennfat_8h_a1ee856dbd0706f79a440d1e98b42d32d}\label{s__pennfat_8h_a1ee856dbd0706f79a440d1e98b42d32d} 
\index{s\_pennfat.h@{s\_pennfat.h}!s\_close@{s\_close}}
\index{s\_close@{s\_close}!s\_pennfat.h@{s\_pennfat.h}}
...
\end{DoxyReturn}
\Hypertarget{s__pennfat_8h_a9ec64e2714b83fdba459578a89d77c32}\label{s__pennfat_8h_a9ec64e2714b83fdba459578a89d77c32} 
\index{s\_pennfat.h@{s\_pennfat.h}!s\_is\_executable@{s\_is\_executable}}
\index{s\_is\_executable@{s\_is\_executable}!s\_pennfat.h@{s\_pennfat.h}}
...
\end{DoxyReturn}
\Hypertarget{s__pennfat_8h_ae166ac7970869bda5550149e8771c3af}\label{s__pennfat_8h_ae166ac7970869bda5550149e8771c3af} 
\index{s\_pennfat.h@{s\_pennfat.h}!s\_ls@{s\_ls}}
\index{s\_ls@{s\_ls}!s\_pennfat.h@{s\_pennfat.h}}
...
\hline
\end{DoxyParams}
\Hypertarget{s__pennfat_8h_a5d3410d3c150ad3ac75e6f061948a31f}\label{s__pennfat_8h_a5d3410d3c150ad3ac75e6f061948a31f} 
\index{s\_pennfat.h@{s\_pennfat.h}!s\_lseek@{s\_lseek}}
\index{s\_lseek@{s\_lseek}!s\_pennfat.h@{s\_pennfat.h}}
...
\end{DoxyReturn}
\Hypertarget{s__pennfat_8h_afec6e61720e05918efefeab347e950f3}\label{s__pennfat_8h_afec6e61720e05918efefeab347e950f3} 
\index{s\_pennfat.h@{s\_pennfat.h}!s\_open@{s\_open}}
\index{s\_open@{s\_open}!s\_pennfat.h@{s\_pennfat.h}}
...
\end{DoxyReturn}
\Hypertarget{s__pennfat_8h_a87d6adb8e7b0eaccc8dd4b1f3ba14e9a}\label{s__pennfat_8h_a87d6adb8e7b0eaccc8dd4b1f3ba14e9a} 
\index{s\_pennfat.h@{s\_pennfat.h}!s\_read@{s\_read}}
\index{s\_read@{s\_read}!s\_pennfat.h@{s\_pennfat.h}}
...
\end{DoxyReturn}
\Hypertarget{s__pennfat_8h_a395873f1de0b89a686d438580ba5dcf7}\label{s__pennfat_8h_a395873f1de0b89a686d438580ba5dcf7} 
\index{s\_pennfat.h@{s\_pennfat.h}!s\_unlink@{s\_unlink}}
\index{s\_unlink@{s\_unlink}!s\_pennfat.h@{s\_pennfat.h}}
...
int 0 on success, negative on failure. 
\end{DoxyReturn}
\Hypertarget{s__pennfat_8h_a2a41e90899b39cae94c9d02c3922ea81}\label{s__pennfat_8h_a2a41e90899b39cae94c9d02c3922ea81} 
\index{s\_pennfat.h@{s\_pennfat.h}!s\_write@{s\_write}}
\index{s\_write@{s\_write}!s\_pennfat.h@{s\_pennfat.h}}
